    ...
    <section  class ="hero">
        <div class="contenido-hero">  
            <ul class="nav ">
                ...
                <ul>
                    <li><a href="OrdenRegistroventas.php">Ventas</a></li>
                </ul>
            </li>
            <li><a href="">Buscar</a>
                <ul>
                    <li><a href="buscarcomision.php">Tabla De Comisiones</a></li>   
                    <li><a href="Bonos_historialAsesor.php">Bonos y Descuentos</a></li>
                    <li><a href="OrdenHistoricoventasAsesor.php">Hisotrico De Ventas</a></li>
                </ul>
            </li>
            <li><a href="">Liquidacion</a>
                <ul>
                    <li><a href="LiquidacionVentasAsesor.php">Liquidacion de Ventas</a></li>   
                    <li><a href="LiquidacionBonosAsesor.php">Liquidacion Bonos y Descuentos</a></li>
                </ul>  
                </li> 
